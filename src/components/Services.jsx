  ...
  return (
    <div className="services">
      ...
      <div className="content">
        <p>
          Dedicated customer service professional with 12 years of experience in
          providing exceptional support and building strong client
          ...
          I am passionate about leveraging these skills in the field of frontend
          development with React, where I can create exceptional user
          experiences and contribute to innovative digital solutions.
          <br /> <br /> <br /> Beyond work, you'll often find me exploring
          virtual worlds in video games. I also love coffee. I really love
          coffee.
        </p>
        <SkillsBar />
      </div>
